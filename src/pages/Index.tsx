          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="text-center space-y-8 animate-slide-in-top">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-green-700 via-green-600 to-emerald-500 bg-clip-text text-transparent leading-tight">
              ...
              <div className="glass-card rounded-xl p-6 event-details">
                <h3 className="text-lg font-semibold text-green-800 mb-4">Event Details</h3>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="flex items-center space-x-3">
                    <Building className="w-5 h-5 text-green-600" />
                    <div>
                      <div className="text-sm text-green-700 font-medium">Location</div>
                      <div className="text-xs text-green-600">Reliance</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Laptop className="w-5 h-5 text-green-600" />
                    <div>
                      <div className="text-sm text-green-700 font-medium">Platform</div>
                      <div className="text-xs text-green-600">MS Teams</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-green-600">Fri, 20 June 2025</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-green-600">3:00 PM - 5:00 PM IST</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="glass-card rounded-xl p-6 text-center space-y-4 animate-bounce-in">
                <div className="w-16 h-16 bg-gradient-to-br from-green-600 to-emerald-500 rounded-full flex items-center justify-center mx-auto">
                  <span className="text-2xl text-white font-bold">AI</span>
                </div>
                <h3 className="text-xl font-semibold text-green-800">AI-Powered</h3>
              ...
              <div className="glass-card rounded-xl p-6 text-center space-y-4 animate-bounce-in" style={{ animationDelay: '0.2s' }}>
                ...
                <h3 className="text-xl font-semibold text-green-800">Lightning Fast</h3>
                <p className="text-green-700">
              ...
              <div className="glass-card rounded-xl p-6 text-center space-y-4 animate-bounce-in" style={{ animationDelay: '0.4s' }}>
                ...
                <h3 className="text-xl font-semibold text-green-800">Production Ready</h3>
                <p className="text-green-700">
